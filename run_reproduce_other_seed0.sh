#!/usr/bin/env bash
# =============================================================================
# run_reproduce_other_seed0.sh — reproduction sweep for nd100, sp500, seed 0
#
# zz500 seed 0 already completed; starts at nd100.
# Run in parallel with run_reproduce_hs300_resume.sh (different markets,
# use DEVICE=cuda:1 if second GPU available).
# =============================================================================
set -uo pipefail
...
FAILLOG="$ORCH/failures_other_seed0.txt"; : > "$FAILLOG"
ts() { date '+%F %T'; }
...
echo "[orch $(ts)] ===== nd100+sp500 seed0 sweep ====="
